...
const port = process.env.PORT || 9090;
  ...
  console.log("APKA BOT APKE WHATSAPP KE SATH CONNECT HO RAHA HAI THORA SA INTAZAR KARE....😊🌺");
...
conn.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
        ...
        if (code !== DisconnectReason.loggedOut) {
            ...
            console.log("BOT ME KUCJ ERRORS THE SHAYAD TO APKA BOT WHATSAPP SE DELETE HO GAYA HAI AP DUBARA SE PAIR CODE YA QR CODE KE ZARIYE BOT KO APNI WHATSAPP SE LINK KARE AUR DUBARA BANAYE SORRY😔 ");
        }

    } else if (connection === 'open') {
        console.log('APKE BO ME COMMANDS ADD HO RAHE HAI....😊🌺');
        fs.readdirSync("./plugins/").forEach((plugin) => {
            if (path.extname(plugin).toLowerCase() === ".js") {
                try {
                    ...
                    console.error(`KUCH PROBLEM HAI BOT ME COMMANDS ADD NAHI HOWE:❯ ${plugin}:`, err);
                }
            }
        });
    
  console.log('STARTING......')
  console.log('APKA BOT APKE WHATSAPP KE SATH CONNECT HO CHUKA HAI AP WHATSAP PER JA KER BOT TEST KARO ENJOY 😊🌺')
  
  let up = `*👑 BILAL-MD STARTED 👑*
  *🔰 BOT WHATSAPP KE SATH CONNECTED HAI AUR BILKUL THIK WORK KAR RAHA HAI 🔰* 
  *🔰 AGAR KOI PROBLEM HO TO AP BOT BANANE WALE SE RABTA KARE 🔰*
  *👑 BILAL :❯ 923078071982 👑*`;
